...
$config['mongo_db']['default']['hostname'] = '123.206.86.59';
$config['mongo_db']['default']['port'] = '27017';
$config['mongo_db']['default']['username'] = 'huihui';
$config['mongo_db']['default']['password'] = 'huihui';
$config['mongo_db']['default']['database'] = 'sina';
